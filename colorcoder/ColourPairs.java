...
public class ColourPairs {
    ...
    public ColourPairs(MajorColor major, MinorColor minor)
    {
        majorColor = major;
        minorColor = minor;
    }
    ...
    static ColourPairs GetColorFromPairNumber(int pairNumber) {
        ...
        return new ColourPairs(majorColor, minorColor);
    }
